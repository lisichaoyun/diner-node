...
let param = qs.stringify({
	...
	appid:'wx4e76924496520712',
	secret:'92aedd6ba3d17b5140d6443a8d1af65a'
})
...
// 云环境id
let env = 'cloud1-4gpttpx2741b0acd'
...
class getToken{
	...
	async subscribe(touser,data){
		try{
			let token = await this.gettoken()
			let OBJ = {touser,data,template_id:'hf0GJqD9WohZj-xxYa0qXsMgRzpYaSPE6qsvd3A4gpE',page:'pages/my-order/my-order',miniprogram_state:'developer'}
